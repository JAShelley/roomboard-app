# VetBoard Tebra/Kareo Capture

Starter appointment-capture extension for Tebra/Kareo.
...
2. Open the Tebra/Kareo schedule/calendar page.
...
Because this was built from public UI research and not a live Tebra/Kareo account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

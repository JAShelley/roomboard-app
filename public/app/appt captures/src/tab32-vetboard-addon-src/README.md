# VetBoard tab32 Capture

Starter appointment-capture extension for tab32.
...
2. Open the tab32 schedule/calendar page.
...
Because this was built from public UI research and not a live tab32 account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

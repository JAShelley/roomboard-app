# VetBoard athenahealth Capture

Starter appointment-capture extension for athenahealth.
...
2. Open the athenahealth schedule/calendar page.
...
Because this was built from public UI research and not a live athenahealth account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

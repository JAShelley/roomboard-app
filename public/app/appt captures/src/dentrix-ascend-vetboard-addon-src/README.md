# VetBoard Dentrix Ascend Capture

Starter appointment-capture extension for Dentrix Ascend.
...
2. Open the Dentrix Ascend schedule/calendar page.
...
Because this was built from public UI research and not a live Dentrix Ascend account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

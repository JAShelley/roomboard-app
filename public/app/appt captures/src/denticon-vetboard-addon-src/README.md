# VetBoard Denticon Capture

Starter appointment-capture extension for Denticon.
...
2. Open the Denticon schedule/calendar page.
...
Because this was built from public UI research and not a live Denticon account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

(function () {
  ...
  // Denticon uses FullCalendar — target those event elements first, then fall back generically
  ...
  // Denticon appointment type → VetBoard label mapping
  ...
  function updateBadgeUi() {
    ...
    let label = "VetBoard Denticon capture idle. Click to arm. Right-click to log in.";
    if (authNeedsLogin) {

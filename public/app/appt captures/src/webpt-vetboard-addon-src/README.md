# VetBoard WebPT Capture

Starter appointment-capture extension for WebPT.
...
2. Open the WebPT schedule/calendar page.
...
Because this was built from public UI research and not a live WebPT account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

# VetBoard Curve Dental Capture

Starter appointment-capture extension for Curve Dental.
...
2. Open the Curve Dental schedule/calendar page.
...
Because this was built from public UI research and not a live Curve Dental account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

(function () {
  ...
  const HOST_HINT_RE = /(?:^|\.)(?:curvehero\.com|curveapps\.com|curvedental\.com)$/i;
  ...
  // Curve Dental appointment type → VetBoard label mapping
  ...
  function updateBadgeUi() {
    ...
    let label = "VetBoard Curve Dental capture idle. Click to arm. Right-click to log in.";
    if (authNeedsLogin) {

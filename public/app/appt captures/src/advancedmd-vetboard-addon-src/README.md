# VetBoard AdvancedMD Capture

Starter appointment-capture extension for AdvancedMD.
...
2. Open the AdvancedMD schedule/calendar page.
...
Because this was built from public UI research and not a live AdvancedMD account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.

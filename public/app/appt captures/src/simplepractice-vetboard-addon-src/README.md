# VetBoard SimplePractice Capture

Starter appointment-capture extension for SimplePractice.
...
2. Open the SimplePractice schedule/calendar page.
...
Because this was built from public UI research and not a live SimplePractice account, the selectors are conservative. Tighten the parser against a real clinic login once you can test it.
